 ...
 */
package flick2know.fieldassist.core.functional

/**
 * refer to this article - (https://medium.com/@LubosMudrak/you-either-love-it-or-you-havent-used-it-yet-a55f9b866dbe)
 *
...
sealed class Either<out L, out R> {
     ...
     * @see Right
     */
    fun <LO, RO> fold(fnL: (L) -> LO, fnR: (R) -> RO): Either<LO, RO> =
        when (this) {
            is Left -> Left(
                fnL(a)
            )
...
fun <L, R> Either<L, R>.leftValue(): L? = when (this) {
    is Either.Left -> a
